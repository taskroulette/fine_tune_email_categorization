...
def get_class_and_list_names(filename="generated_code.py"):
    ...
    class_names = [line.split()[1] for line in content.splitlines() if line.strip().startswith('class ')]
    ...
    list_name_lines = [line for line in content.splitlines() if '=' in line and '[' in line]
